 ...
 * chess-academy.jsx
 *
 * The React UI layer of Chess Academy — an interactive chess learning app
 ...
 *
 * All core chess data (pieces, board, openings, concepts, quizzes) and the
 * `applyMoves` helper live in `chess-core.js` and are imported here.
 * The default export `ChessAcademy` is a self-contained React component —
 * drop it into any React project to run the app.
 *
 * @module chess-academy
 */
import { useState } from "react";
import { PIECES, OPENINGS, CONCEPTS, QUIZZES } from "./chess-core.js";
